...
public class FoodAdapter extends RecyclerView.Adapter<FoodAdapter.FoodViewHolder> {
    private ArrayList<FoodInfo> foodInfos =new ArrayList<FoodInfo>();

    public FoodAdapter(ArrayList<FoodInfo> foodInfos) {
